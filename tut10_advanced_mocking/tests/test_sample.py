...
from tut10_advanced_mocking.myapp.sample import random_sum, silly


@mock.patch("tut10_advanced_mocking.myapp.sample.random.randint")
...
@mock.patch("tut10_advanced_mocking.myapp.sample.random.randint")
@mock.patch("tut10_advanced_mocking.myapp.sample.time.time")
@mock.patch("tut10_advanced_mocking.myapp.sample.requests.get")
